...
class Var:
    ...
    MONGO_SRV = config("MONGO_SRV", default=mongodb+srv://rohitplayer87089:rohit870@cluster0.4wt927p.mongodb.net/?retryWrites=true&w=majority)

    # Channels Ids

    BACKUP_CHANNEL = config("BACKUP_CHANNEL", default=-1002370816678, cast=int)
    MAIN_CHANNEL = config("MAIN_CHANNEL", -1002370816678, cast=int)
    LOG_CHANNEL = config("LOG_CHANNEL", -1002370816678, cast=int)
    CLOUD_CHANNEL = config("CLOUD_CHANNEL", -1002370816678, cast=int)
    ...
    FORCESUB_CHANNEL_LINK = config("FORCESUB_CHANNEL_LINK", default="https://t.me/+tKRLKu4T6Kc4N2E1", cast=str)
